...
from .models import Tip, Users, Admin, Service, UserService
from .models import TipCommints, Fav, Products, UserProducts, UserTips
...
#     list_display = ('_id', 'tip_id', 'user_id')


class AdminsAdmin(admin.ModelAdmin):
    list_display = ('_id', 'admin_name', 'admin_email', 'admin_password')
...
class UserServiceAdmin(admin.ModelAdmin):
    list_display = ('_id', 'user_id', 'service_id', 'user_service_location',
