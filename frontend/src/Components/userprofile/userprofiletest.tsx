                    ...
                    <div className="profile-side">
                        ...
                        <div className="user-pio">
                            <p className="pio"> Bio :
                                ...
                                {JSON.parse(test.userinfo).user_bio}
                            </p>
                        </div>
                        <div className="button">
                            <input className="button-img"
                                type="button"
                                value="change image"
                                onClick={togglePopup}
                            />
                        ...
                        <p className="date" ><TimeAgo date={'Mon Dec 14 2020 16:03:46 GMT+0200 (Israel Standard Time)'} /></p>
